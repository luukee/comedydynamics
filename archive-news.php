...
$hero_image_alt = $hero_image['alt']; /* Get image object alt */
...
<div class="main-container">
	...
	<div class="main-grid">
      ...
      <!-- https://developer.wordpress.org/reference/functions/query_posts/ -->
		<?php $posts = query_posts($query_string . "&posts_per_page=-1&order=DESC");
        if (have_posts()) : ?>
            ...
            <div class="grid-x grid-padding-y feed-container">
              ...
              <div class="cell medium-4">
								...
								<a href="<?php echo $link; ?>" target="_blank" rel="noreferrer">
									<img class="slideInFromBottom" data-interchange="[<?php the_post_thumbnail_url('fp-small'); ?>, small], [<?php the_post_thumbnail_url('fp-medium'); ?>, medium], [<?php the_post_thumbnail_url('fp-large'); ?>, large], [<?php the_post_thumbnail_url('fp-xlarge'); ?>, xlarge]" alt="<?php echo $hero_image_alt; ?>">
								<?php echo '</a>'; ?>
								<?php endif; ?>
                ...
                <div class="grid-x">
                    ...
                    if (is_single()) {
                        ...
                        the_title('<h4 class="entry-title"><a href="' . esc_url($link) . '" target="_blank" rel="noreferrer">', '</a></h4>');
                    }
                    echo '</a>';
                  ?>
								</div>
                  ...
                  <div class="cell text-right mic">
                    <img src="<?php bloginfo('template_directory'); ?>/dist/assets/images/comedy-dynamics-mic.png" alt="Comedy Dynamics Microphone Icon" />
                  </div>

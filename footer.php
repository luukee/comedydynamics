...
<footer class="cell shrink footer">
            ...
            <div class="grid-x social">
              <div class="cell text-center">
                <?php while (have_rows('social_media', 'option')) : the_row(); ?>
                  ...
                  echo '<a class="nav-link" rel="nofollow noopener noreferrer" href="' . $socialurl . '" target="_blank" aria-label="' . $socialchannel . '">';
                  ?>
  ...
  <div class="reveal" id="newsletterModal1" data-reveal>
    ...
    <script type='text/javascript' src='<?php bloginfo('template_directory'); ?>/dist/assets/js/local-mc-validate.js'></script>
